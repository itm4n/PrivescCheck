...
"SERVICE_DLL_HIJACKING", "", "Invoke-DllHijackingCheck", "", "Services", "PATH Folder Permissions", "Vuln", "High", "Retrieve the list of SYSTEM %PATH% folders and check whether the current user has some write permissions in any of them.", "List", False, False

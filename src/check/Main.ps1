...
"APP_STARTUP_INFO",               "Invoke-ApplicationsOnStartupCheck -Info",    "TA0004 - Privilege Escalation", "Startup applications (info)",         "None",     "List",   "Extended",     "True",       "False", "Get information about system-wide applications that are run at startup for all users."
...
"UPDATE_HOTFIX_INFO",             "Invoke-HotFixCheck -Info",                   "TA0004 - Privilege Escalation", "Windows Update history",              "None",     "Table",  "Extended",     "True",       "False", "Get information about Windows Update history. Update packages are sorted by date in descending order, so that most recent ones are shown first. Note that the script might fail to retrieve install dates when run with PowerShell version 2."
...
"MISC_STARTUP_LAST",              "Invoke-SystemStartupCheck",                  "TA0004 - Privilege Escalation", "Last system startup time",            "None",     "Table",  "Extended",     "True",       "False", "Get information about the last startup date and time based on the machine's tick count. Note that the result might not be completely reliable."

...
"CONFIG_SMB",                     "Invoke-SmbConfigurationCheck",               "TA0008 - Lateral Movement",     "SMB configuration",                   "Low",      "List",   "Audit",        "True",       "False", "Check whether SMBv1 is enabled (server), and whether signing is required (server and client)."
...
"CONFIG_DEFENDER_EXCLUSIONS",     "Invoke-DefenderExclusionsCheck",             "TA0005 - Defense Evasion",      "Windows Defender exclusions",         "None",     "Table",  "Extended",     "True",       "False", "Get information about the exclusions configured in Microsoft Defender."

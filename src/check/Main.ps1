...
"HARDEN_PS_EXEC_POLICY",          "Invoke-PowerShellExecutionPolicyCheck",      "TA0001 - Initial Access",       "PowerShell script execution policy",  "Low",      "List",   "True",     "True",       "False",        "Check whether a PowerShell script execution policy is enforced."

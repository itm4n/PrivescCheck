...
"CREDS_SENSITIVE_HIVE_FILES",       "Invoke-SensitiveHiveFileAccessCheck",          "Creds",            "SAM/SYSTEM/SECURITY Files",            "Vuln", "Medium",   "List",     "False",    "False",        "False",        "Check whether some backup files of the SAM/SYSTEM hives were created with insecure permissions."

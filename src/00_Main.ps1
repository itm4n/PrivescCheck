...
"CONFIG_PRINTNIGHTMARE",            "Invoke-PrintNightmareCheck",                   "Config",           "Point and Print",                      "Vuln", "High",     "List",     "False",    "True",         "False",        "Checks whether the Print Spooler service is enabled and if the Point and Print configuration allows low-privileged users to install printer drivers (even on a fully up-to-date machine)."

...
"CONFIG_COINSTALLERS",              "Invoke-RegistryDisableCoInstallersCheck",      "Config",           "DisableCoInstallers",                  "Vuln", "High",     "List",     "False",    "True",         "False",        "Check whether the 'DisableCoInstallers' registry key is absent or disabled. If so any user might be able to run arbitrary code with SYSTEM privileges by plugging a device automatically installing vulnerable software along with its driver."

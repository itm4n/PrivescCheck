...
"CONFIG_UNCPATHS",                  "Invoke-HardenedUNCPathCheck",                  "Config",           "UNC Path to SYSVOL",                   "Vuln", "Medium",   "List",     "False",    "True",         "False",        "Check whether the UNC path to SYSVOL is hardened. If not, a man in the middle might be able to run arbitrary code with SYSTEM privileges by injecting malicious group policies during a group policy update."

...
"APP_STARTUP_INFO",                 "Invoke-ApplicationsOnStartupCheck -Info",      "Apps",             "Startup Apps",                         "Info", "Info",     "List",     "True",     "True",         "False",        "Enumerate the system-wide applications that are run on start-up."
"APP_STARTUP",                      "Invoke-ApplicationsOnStartupCheck",            "Apps",             "Modifiable Startup Apps",              "Vuln", "Medium",   "List",     "True",     "False",        "False",        "Enumerate the system-wide applications that are run on start-up and check whether they can be modified by the current user."

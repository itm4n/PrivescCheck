...
"NET_AIRSTRIKE",                  "Invoke-AirstrikeAttackCheck",                "TA0001 - Initial Access",       "Network selection from lock screen",  "Low",      "List",     "True",     "True",         "False",        "Checks whether the 'Do not display network selection UI' policy is enforced on workstations (c.f. Airstrike attack)."
